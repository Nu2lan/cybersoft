  ...
  if (validateForm()) {
    ...
    try {
      ...
      if (response.ok && result.success) {
        ...
        toast({
          title: t.contact.form.errors.sendError,
          description: result.error || t.contact.form.errors.sendErrorDescription,
          variant: "destructive",
        })
      }
    } catch (error) {
      ...
      toast({
        title: t.contact.form.errors.networkError,
        description: t.contact.form.errors.networkErrorDescription,
        variant: "destructive",
      })
    } finally {
